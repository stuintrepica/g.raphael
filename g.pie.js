...
(function () {
    ...
    function Piechart(paper, cx, cy, r, values, opts) {
        ...
        if (len == 1) {
            var colors = opts.colors ? opts.colors : chartinst.colors;
            series.push(paper.circle(cx, cy, r).attr({ fill: colors[0], stroke: opts.stroke || "#fff", "stroke-width": opts.strokewidth == null ? 1 : opts.strokewidth }));
